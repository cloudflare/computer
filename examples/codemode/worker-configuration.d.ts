/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: eef8eb1dc589a9c80221e0cfdb2a52f3)
// Runtime types generated with workerd@1.20260722.1 2026-06-17 experimental,nodejs_compat
interface __BaseEnv_Env {
	LOADER: WorkerLoader;
	CodemodeExample: DurableObjectNamespace<import("./src/index").CodemodeExample>;
	CODEMODE_RUNTIME: DurableObjectNamespace<import("./src/index").CodemodeRuntime>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "CodemodeExample";
	}
