/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f7d0847f7c89d072a618d5b30be433dc)
// Runtime types generated with workerd@1.20260616.1 2026-05-26 experimental,nodejs_compat
interface __BaseEnv_Env {
	LOADER: WorkerLoader;
	AI: Ai;
	CodemodeExample: DurableObjectNamespace<import("./src/index").CodemodeExample>;
	AgentSession: DurableObjectNamespace<import("./src/index").AgentSession>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "CodemodeExample" | "AgentSession";
	}
