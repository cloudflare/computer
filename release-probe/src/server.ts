...
export default {
  async fetch(request: Request, env: Env): Promise<Response> {
    ...
    const stub = env.ReproContainer.get(env.ReproContainer.idFromName("demo-release-0.3.0"));
    try {
      ...
      return Response.json({
        packageVersion: "0.3.0 (release branch preview 1233647)",
        image: "ghcr.io/cloudflare/computer-computerd-linux-x64:0.3.0",
        ok: true,
